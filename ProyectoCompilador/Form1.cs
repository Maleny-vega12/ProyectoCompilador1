    ...
    public partial class Form1 : Form
    {
        ...
        private void cmbxLenguajes_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cmbxLenguajes.SelectedValue != null && int.TryParse(cmbxLenguajes.SelectedValue.ToString(), out selectedId))
            {
                if (selectedId == 1)
                {
                    ruta = @"C:\Users\Juand\OneDrive\Escritorio\ProyectoCompilador\ProyectoCompilador\ProyectoCompilador\bin\Debug\Matrices de estados" + selectedId.ToString() + ".csv";
                    ...
                    try
                    {
                        ...
                        rutaV = @"C:\Users\Juand\OneDrive\Escritorio\ProyectoCompilador\ProyectoCompilador\ProyectoCompilador\bin\Debug\Palabras Reservadas\PR_VisualBasic.csv";
                        string renglonV;
            ...
            else if (selectedId == 2)
            {
                ...
                try
                {
                    ...
                    rutaV = @"C:\Users\Juand\OneDrive\Escritorio\ProyectoCompilador\ProyectoCompilador\ProyectoCompilador\bin\Debug\Palabras Reservadas\PRBasic.csv";
                    string renglonV;
                    using (StreamReader lector = new StreamReader(rutaV))
                    {
                        renglonV = lector.ReadLine();
            ...
            {
                ruta = @"C:\Users\Juand\OneDrive\Escritorio\ProyectoCompilador\ProyectoCompilador\ProyectoCompilador\bin\Debug\Matrices de estados\Matrices de estados\" + selectedId.ToString() + ".csv";
                ...
                try
                {
                    ...
                    rutaV = @"C:\Users\Juand\OneDrive\Escritorio\ProyectoCompilador\ProyectoCompilador\ProyectoCompilador\bin\Debug\Palabras Reservadas\PRC.csv";
                    string renglonV;
                    using (StreamReader lector = new StreamReader(rutaV))
                    {
                        renglonV = lector.ReadLine();
            ...
            else if (selectedId == 4)
            {
                ...
                try
                {
                    ...
                    rutaV = @"C:\Users\Juand\OneDrive\Escritorio\ProyectoCompilador\ProyectoCompilador\ProyectoCompilador\bin\Debug\Palabras Reservadas\PRClipper.csv";
                    string renglonV;
                    using (StreamReader lector = new StreamReader(rutaV))
                    {
                        renglonV = lector.ReadLine();
            ...
            else if (selectedId == 5)
            {
                ...
                try
                {
                    ...
                    rutaV = @"C:\Users\Juand\OneDrive\Escritorio\ProyectoCompilador\ProyectoCompilador\ProyectoCompilador\bin\Debug\Palabras Reservadas\PRCobol.csv";
                    string renglonV;
                    using (StreamReader lector = new StreamReader(rutaV))
                    {
                        renglonV = lector.ReadLine();
            ...
            else if (selectedId == 6)
            {
                ...
                try
                {
                    ...
                    rutaV = @"C:\Users\Juand\OneDrive\Escritorio\ProyectoCompilador\ProyectoCompilador\ProyectoCompilador\bin\Debug\Palabras Reservadas\PRDbase.csv";
                    string renglonV;
                    using (StreamReader lector = new StreamReader(rutaV))
                    {
                        renglonV = lector.ReadLine();
            ...
            else if (selectedId == 7)
            {
                ...
                try
                {
                    ...
                    rutaV = @"C:\Users\Juand\OneDrive\Escritorio\ProyectoCompilador\ProyectoCompilador\ProyectoCompilador\bin\Debug\Palabras Reservadas\PRFortran.csv";
                    string renglonV;
                    using (StreamReader lector = new StreamReader(rutaV))
                    {
                        renglonV = lector.ReadLine();
            ...
            else if (selectedId == 8)
            {
                ...
                try
                {
                    ...
                    rutaV = @"C:\Users\Juand\OneDrive\Escritorio\ProyectoCompilador\ProyectoCompilador\ProyectoCompilador\bin\Debug\Palabras Reservadas\PRJava.csv";
                    string renglonV;
                    using (StreamReader lector = new StreamReader(rutaV))
                    {
                        renglonV = lector.ReadLine();
            ...
            else if (selectedId == 9)
            {
                ...
                try
                {
                    ...
                    rutaV = @"C:\Users\Juand\OneDrive\Escritorio\ProyectoCompilador\ProyectoCompilador\ProyectoCompilador\bin\Debug\Palabras Reservadas\PRPascal.csv";
                    string renglonV;
                    using (StreamReader lector = new StreamReader(rutaV))
                    {
                        renglonV = lector.ReadLine();
            ...
            else if (selectedId == 10)
            {
                ...
                try
                {
                    ...
                    rutaV = @"C:\Users\Juand\OneDrive\Escritorio\ProyectoCompilador\ProyectoCompilador\ProyectoCompilador\bin\Debug\Palabras Reservadas\PRPython.csv";
                    string renglonV;
                    using (StreamReader lector = new StreamReader(rutaV))
                    {
                        renglonV = lector.ReadLine();
            ...
            else if (selectedId == 11)
            {
                ...
                try
                {
                    ...
                    rutaV = @"C:\Users\Juand\OneDrive\Escritorio\ProyectoCompilador\ProyectoCompilador\ProyectoCompilador\bin\Debug\Palabras Reservadas\PRVisualFoxPro.csv";
                    string renglonV;
                    using (StreamReader lector = new StreamReader(rutaV))
                    {
                        renglonV = lector.ReadLine();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string rutaCompletaArchivo = Path.Combine(@"C:\\Users\\Juand\\OneDrive\\Escritorio\\ProyectoCompilador\\ProyectoCompilador\\ProyectoCompilador\\bin\\Debug\\Outputs\\", nombreArchivo);
